...
enum optionindex {
    OPT_HASH_TAB_SIZE             = 0,
    OPT_DICT_WORD_SIZE            = 1,
    OPT_DICT_CHAR_SIZE            = 2,
    OPT_GRAMMAR_VERSION           = 3,
    OPT_GRAMMAR_META_FLAG         = 4,
    OPT_NUM_ATTR_BYTES            = 5,
    OPT_ZCODE_HEADER_EXT_WORDS    = 6,
    OPT_ZCODE_HEADER_FLAGS_3      = 7,
    OPT_ZCODE_FILE_END_PADDING    = 8,
    OPT_ZCODE_LESS_DICT_DATA      = 9,
    OPT_ZCODE_MAX_INLINE_STRING   = 10,
    OPT_GLULX_OBJECT_EXT_BYTES    = 11,
    OPT_MAX_ABBREVS               = 12,
    OPT_MAX_DYNAMIC_STRINGS       = 13,
    OPT_INDIV_PROP_START          = 14,
    OPT_MAX_STACK_SIZE            = 15,
    OPT_MEMORY_MAP_EXTENSION      = 16,
